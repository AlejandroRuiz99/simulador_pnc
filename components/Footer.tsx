        ...
        <div className="grid md:grid-cols-3 gap-12 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a
                  href="https://sede.seg-social.gob.es"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-gray-400 hover:text-gold transition-colors text-sm"
                >
              ...
              <li>
                <a
                  href="https://sede.seg-social.gob.es/wps/portal/sede/sede/Inicio/ofipre"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-gray-400 hover:text-gold transition-colors text-sm"
                >
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start gap-2 text-sm text-gray-400 mt-4 pt-4 border-t border-gray-700">
                <svg className="w-5 h-5 text-gray-500 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clipRule="evenodd" />
                </svg>
                <span className="text-gray-500 text-xs">Información Seguridad Social: 901 16 65 65</span>
              </li>
              <li className="flex items-start gap-2 text-sm text-gray-400">
        ...
        <div className="border-t border-gold/10 pt-8 mb-8">
          <div className="bg-gray-900/50 border border-gold/20 rounded-lg p-6">
            ...
            <p className="text-sm text-gray-400 leading-relaxed">
              ...
              orientativo en su navegador. Para una evaluación definitiva de su situación particular, debe consultar con la 
              <a href="https://www.seg-social.es" target="_blank" rel="noopener noreferrer" className="text-gold hover:underline ml-1">
                Seguridad Social
              </a>.
            </p>
          </div>
